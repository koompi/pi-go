...
func TestParsing(t *testing.T) {
	...
	urls := []string{
		...
		"git://github.com/jguer/pi.git#branch=master",
		"git://github.com/davidgiven/ack",
		"git://github.com/jguer/pi.git#tag=v3.440",
		"git://github.com/jguer/pi.git#commit=e5470c88c6e2f9e0f97deb4728659ffa70ef5d0c",
		"a+b+c+d+e+f://github.com/jguer/pi.git#branch=foo",
	}

	sources := []source{
		{"github.com/neovim/neovim.git", "HEAD", []string{"https"}},
		{"github.com/jguer/pi.git", "master", []string{"git"}},
